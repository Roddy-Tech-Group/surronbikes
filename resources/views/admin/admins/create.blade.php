    ...
    <form method="POST" action="{{ route('admin.admins.store') }}">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden max-w-3xl">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                ...
                <p class="mt-1 text-sm text-gray-500">Add a new administrator. They will have full access to the backend.</p>
            </div>
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm">
                        @error('name')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div class="sm:col-span-2">
                        <label for="email" class="block text-sm font-medium text-gray-700">Email Address</label>
                        <input type="email" name="email" id="email" value="{{ old('email') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-4">
                        <div class="flex items-center">
                            <input id="status_active" name="is_active" type="radio" value="1" {{ old('is_active', '1') == '1' ? 'checked' : '' }} class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300">
                        ...
                        <div class="flex items-center">
                            <input id="status_inactive" name="is_active" type="radio" value="0" {{ old('is_active') == '0' ? 'checked' : '' }} class="focus:ring-orange-500 h-4 w-4 text-orange-600 border-gray-300">
