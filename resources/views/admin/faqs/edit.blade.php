        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden max-w-3xl">
            <div class="p-6 sm:p-8 space-y-8">
                ...
                <div>
                    ...
                    <input type="text" name="question" id="question" value="{{ old('question', $faq->question) }}" required maxlength="255" class="block w-full">
                ...
                <div class="w-1/3 min-w-[180px]">
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $faq->sort_order) }}" required min="0" class="block w-full">
