                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 rounded-lg flex items-center justify-center bg-gray-50 border border-gray-100 p-1 flex-shrink-0 shadow-sm">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">{{ $method->type_label }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
