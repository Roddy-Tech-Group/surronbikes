                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="slug" id="slug" x-model="slug" class="mt-1 py-3 px-4 shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full text-base border-gray-400 rounded-md placeholder-gray-400" placeholder="Auto-generated if left blank">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price') }}" required step="0.01" min="0" class="focus:ring-orange-500 focus:border-orange-500 py-3 block w-full pl-9 pr-12 text-base border-gray-400 rounded-md" placeholder="0.00">
                                </div>
            ...
            <div class="space-y-6">
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="images" class="relative cursor-pointer bg-white rounded-md font-medium text-orange-600 hover:text-orange-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-orange-500">
                                            ...
                                            <input id="images" name="images[]" type="file" multiple class="sr-only" accept="image/jpeg,image/png,image/webp" required @change="handleFileChange">
                                        </label>
                                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <input type="url" name="video_url" id="video_url" value="{{ old('video_url') }}" class="mt-1 py-3 px-4 shadow-sm focus:ring-orange-500 focus:border-orange-500 block w-full text-base border-gray-400 rounded-md" placeholder="YouTube or Vimeo URL">
